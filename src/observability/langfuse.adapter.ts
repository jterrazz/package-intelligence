  ...
  generation(params: GenerationParams): void {
    const usageDetails = params.usage
      ? {
          ...
          ...(params.usage.reasoning !== undefined && { reasoning: params.usage.reasoning }),
          ...(params.usage.cacheRead !== undefined && { cache_read: params.usage.cacheRead }),
          ...(params.usage.cacheWrite !== undefined && { cache_write: params.usage.cacheWrite }),
        }
      : undefined;
